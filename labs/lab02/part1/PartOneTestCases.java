...
public class PartOneTestCases
{
   ...
   @Test
   public void testPeriCircle() {
      double d = Util.perimeter(new Circle(new Point(0,4), 1.0));
      assertEquals(6.283185307179586, d, DELTA);
   }
   @Test
   public void testPeriRect() {
      Point br = new Point(3,0);
      Point tl = new Point(0,4);
      double d = Util.perimeter(new Rectangle(tl, br));
      assertEquals(9.0, d, DELTA);
   }
